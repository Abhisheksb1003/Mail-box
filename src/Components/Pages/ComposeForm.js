...
const ComposeForm = () => {
    ...
    const mailSubmitHandler = (e) => {
      ...
      fetch(
        `https://expensetracker-7313d-default-rtdb.firebaseio.com/sent/${sendingemail}.json`,
        {
          method: "POST",
      ...
      fetch(
        `https://expensetracker-7313d-default-rtdb.firebaseio.com/received/${receivedemail}.json`,
        {
          method: "POST",
          body: JSON.stringify(data),
          headers: {
